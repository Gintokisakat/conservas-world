"""
Script de traducción y refinamiento para aceitunas confitadas y aditivos en francés.
...
def translate_confited():
    ...
    print(f"📦 Procesando {len(products)} productos de aceitunas confitadas y aditivos...")

    cleaned_count = 0

    confited_vocab = [
        # Títulos
        (r"\bAceitunas noires confites\b", "Aceitunas negras confitadas"),
        (r"\bnoires confites\b", "negras confitadas"),
        (r"\bconfites\b", "confitadas"),

        # Descripciones y aditivos
        (r"\bAceitunas noires\b", "Aceitunas negras"),
        (r"\bgluconate ferreux\b", "gluconato ferroso"),
        (r"\blactate de fer\b", "lactato ferroso"),
        (r"\bchlorure de calcium\b", "cloruro de calcio"),
        (r"\bcitrate de sodium\b", "citrato de sodio"),
        (r"\bacide ascorbique\b", "ácido ascórbico"),
    ...
    for pid, orig_name, desc in products:
        ...
        for pat, repl in confited_vocab:
    ...
    conn.close()
    print(f"\n🎉 Proceso completado: {cleaned_count} productos de aceitunas confitadas y aditivos actualizados.")
